...
import { fmt, fmtCurrency, fmtPct, fmtK, fmtKMBT, clr } from '../utils/format'
...
const INDICATOR_INFO: Partial<Record<SortKey, string>> = {
...
function ValueWithNote({ value, note }: { value: ReactNode; note?: string }) {
  return (
            ...
            <tbody>
              {sorted.map(p => (
                ...
                >
                  ...
                  <td style={{ padding: '10px 14px', textAlign: 'right', fontFamily: "'DM Mono', monospace", fontSize: 13, color: p.fcf != null ? clr(p.fcf) : '#c0c0c0' }}>
                    <ValueWithNote value={p.fcf != null ? fmtKMBT(p.fcf) : '—'} note={p.fcfInterpretation} />
                  </td>
                  <td style={{ padding: '10px 14px', textAlign: 'right', fontFamily: "'DM Mono', monospace", fontSize: 13, color: '#c0c0c0' }}>
