            ...
            <tbody>
              {sorted.map(p => (
                ...
                >
                  ...
                  <td style={{ padding: '10px 14px', textAlign: 'right', fontFamily: "'DM Mono', monospace", fontSize: 13, color: p.fcf != null ? clr(p.fcf) : '#c0c0c0' }} title={p.fcfInterpretation}>{p.fcf != null ? fmtKMBT(p.fcf) : '—'}</td>
